...
function Cube({ x, y, size=44, rot=0, anim='floatA', delay=0, label=null }) {
  return (
    <div style={{ position:'absolute', left:x+'%', top:y+'%', pointerEvents:'none', animation:anim+' '+(6+delay)+'s ease-in-out infinite', animationDelay:delay+'s' }}>
...
export default function LandingPage() {
  ...
  return (
    <div style={{ fontFamily:'Share Tech Mono,monospace', background:'#F0EDE8', color:'#3C091E' }}>
      ...
      ══════════════════════════════════════════════════════════════════ */}
      <section style={{ minHeight:'100vh', display:'grid', gridTemplateColumns:'55% 45%', position:'relative', overflow:'hidden' }}>

        {/* Left — deep maroon */}
        <div style={{ background:'#3C091E', padding:'100px 56px 80px 40px', display:'flex', flexDirection:'column', justifyContent:'flex-end', position:'relative', overflow:'hidden' }}>
          {/* Grid pattern */}
        ...
        <div style={{ background:'#F0EDE8', padding:'120px 40px 80px 64px', display:'flex', flexDirection:'column', justifyContent:'flex-end', position:'relative' }}>
      ...
      ══════════════════════════════════════════════════════════════════ */}
      <section style={{ minHeight:'90vh', display:'grid', gridTemplateColumns:'55% 45%', background:'#3C091E', position:'relative', overflow:'hidden' }}>
      ...
      <section id="feat" style={{ background:'#F0EDE8', minHeight:'90vh', position:'relative', padding:'100px 40px', overflow:'hidden' }}>
        ...
        <Cube x={5} y={8} size={58} rot={15} anim="floatA" delay={0} label="// TIN REGISTRATION" />
        <Cube x={82} y={5} size={42} rot={-8} anim="floatB" delay={1} />
        <Cube x={12} y={45} size={36} rot={22} anim="floatC" delay={2} />
        <Cube x={88} y={38} size={64} rot={-12} anim="floatA" delay={0.5} label="// AI JOB MATCH" />
        <Cube x={6} y={72} size={48} rot={10} anim="floatB" delay={1.5} />
        <Cube x={78} y={68} size={40} rot={-18} anim="floatC" delay={0.8} label="// KUYA AI" />
        <Cube x={45} y={5} size={32} rot={30} anim="floatA" delay={2.2} />
        <Cube x={55} y={80} size={52} rot={-5} anim="floatB" delay={1.2} />
        ...
        <div style={{ maxWidth:1100, margin:'0 auto', display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:1, background:'rgba(60,9,30,0.08)', position:'relative', zIndex:2 }}>
          {[
      ...
      <section id="how" style={{ background:'#F0EDE8', position:'relative', padding:'100px 40px', overflow:'hidden' }}>
        {/* More floating cubes */}
        <Cube x={3} y={10} size={50} rot={12} anim="floatC" delay={0.3} />
        <Cube x={90} y={15} size={38} rot={-20} anim="floatA" delay={1.4} />
        <Cube x={7} y={60} size={44} rot={8} anim="floatB" delay={0.7} label="// STEP PROCESS" />
        <Cube x={87} y={55} size={56} rot={-14} anim="floatC" delay={2} />
        <Cube x={45} y={5} size={30} rot={25} anim="floatA" delay={1.8} />
      ...
      ══════════════════════════════════════════════════════════════════ */}
      <section id="kuya" style={{ minHeight:'90vh', display:'grid', gridTemplateColumns:'55% 45%', background:'#3C091E', position:'relative', overflow:'hidden' }}>
        <div style={{ position:'absolute', inset:0, backgroundImage:'linear-gradient(rgba(240,237,232,0.03) 1px,transparent 1px),linear-gradient(90deg,rgba(240,237,232,0.03) 1px,transparent 1px)', backgroundSize:'55px 55px', pointerEvents:'none' }} />
      ...
      <section style={{ background:'#3C091E', padding:'100px 40px', position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ maxWidth:1200, margin:'0 auto', display:'grid', gridTemplateColumns:'1fr auto', alignItems:'center', gap:80, position:'relative', zIndex:2 }}>
          <div>
          ...
          <div className="rev d2" style={{ display:'flex', flexDirection:'column', gap:12 }}>
